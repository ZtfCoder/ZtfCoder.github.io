import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4sxKuair.js";const h=JSON.parse('{"title":"linux压缩包","description":"","frontmatter":{"title":"linux压缩包","tags":["linux"],"categories":"linux","abbrlink":"a2a4f4f9"},"headers":[],"relativePath":"main/Linux/Linux压缩包.md","filePath":"main/Linux/Linux压缩包.md","lastUpdated":1713751059000}'),e={name:"main/Linux/Linux压缩包.md"},l=p(`<h2 id="下载安装zip" tabindex="-1">下载安装zip <a class="header-anchor" href="#下载安装zip" aria-label="Permalink to &quot;下载安装zip&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#在命令行输入</span></span>
