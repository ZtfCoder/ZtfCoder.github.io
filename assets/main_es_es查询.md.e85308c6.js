import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.1baa841b.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"main/es/es查询.md","filePath":"main/es/es查询.md","lastUpdated":1699428302000}'),p={name:"main/es/es查询.md"},o=l(`<h2 id="聚合桶分页" tabindex="-1">聚合桶分页 <a class="header-anchor" href="#聚合桶分页" aria-label="Permalink to &quot;聚合桶分页&quot;">​</a></h2><div class="language-elm vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">elm</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#79B8FF;">GET</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">/</span><span style="color:#E1E4E8;">interface_indicator</span><span style="color:#F97583;">/</span><span style="color:#E1E4E8;">_search</span></span>
...
<span class="line"><span style="color:#032F62;">  &quot;&quot;&quot;</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div>`,4),e=[o];function t(c,r,E,y,i,u){return n(),a("div",null,e)}const b=s(p,[["render",t]]);export{q as __pageData,b as default};
