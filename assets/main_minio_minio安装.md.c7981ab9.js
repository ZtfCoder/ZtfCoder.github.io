import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.1baa841b.js";const l="/assets/image-20220914113730822.a80e33f3.png",e="/assets/image-20220914111829483.e2ddcd8e.png",o="/assets/image-20220914112115388.7b0a1ddb.png",c="/assets/image-20220914112219196.c5ff2f64.png",r="/assets/image-20220914112410642.f6ecf960.png",t="/assets/image-20220914112504082.7706d3ee.png",v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"main/minio/minio安装.md","filePath":"main/minio/minio安装.md","lastUpdated":1699426983000}'),i={name:"main/minio/minio安装.md"},y=p(`<h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h2><p><code>minio</code> 是一款高性能分布式文件存储软件</p><p>之前采用的<code>fastdfs</code> ,官方整合 docker,极其难用,第三方的整合也是很多坑点,而<code>minio</code> 则官方 docker 镜像,构建简单,并且自带的图形化界面</p><h2 id="分布式介绍" tabindex="-1">分布式介绍 <a class="header-anchor" href="#分布式介绍" aria-label="Permalink to &quot;分布式介绍&quot;">​</a></h2><p>所谓分布式存储,则是上传一分文件,你可以通过放问不同服务都可以访问到这个文件,</p><p>使用的是<code>纠删码</code>,是一种恢复丢失和损坏数据的数学算法， Minio 默认采用 Reed-Solomon code 将数据拆分成 N/2 个数据块和 N/2 个奇偶校验块。这就意味着如果是 16 块盘，一个对象会被分成 8 个数据块、8 个奇偶校验块，你可以丢失任意 8 块盘（不管其是存放的数据块还是校验块），你仍可以从剩下的盘中的数据进行恢复。</p><h2 id="单机部署" tabindex="-1">单机部署 <a class="header-anchor" href="#单机部署" aria-label="Permalink to &quot;单机部署&quot;">​</a></h2><div class="language-yaml vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#85E89D;">version</span><span style="color:#E1E4E8;">: </span><span style="color:#9ECBFF;">&quot;1&quot;</span></span>
