import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.1baa841b.js";const m=JSON.parse('{"title":"linux压缩包","description":"","frontmatter":{"title":"linux压缩包","tags":["linux"],"categories":"linux","abbrlink":"a2a4f4f9"},"headers":[],"relativePath":"src/main/Linux/Linux压缩包.md","filePath":"src/main/Linux/Linux压缩包.md","lastUpdated":1713749248000}'),p={name:"src/main/Linux/Linux压缩包.md"},l=e(`<h2 id="下载安装zip" tabindex="-1">下载安装zip <a class="header-anchor" href="#下载安装zip" aria-label="Permalink to &quot;下载安装zip&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">#在命令行输入</span></span>
